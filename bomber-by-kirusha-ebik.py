...
_phone = input("\n ку ёбик, введи номерочек епта тока без плюсика: ")
if _phone[0] == "+":
...
CLOSE_AFTER = kol
call = input("\n атака смс - 1 (чтобы найти пасхалочку - введи буковки)")

if call == 88005553535:
    print(Fore.RED)
    print("лучше позвонить чем у кого то занимать")

if call == "я хачу пиццы":
    print("я тоже хачу пиццы...")

if call == "спиздил":
    print("За основу взят 'SMS-Bomber-300'")
    print("Точнее сервисы, я выражаю автору данного бомбера огромную благодарность")
    print("И хочу похвалить его за проделанную работу!")

if call == "тимур баринов сосёт большой хуй":
    print("ПоправОчка - огромный!")
...
if call == str(1):
    ...
    while True:
        ...
        R = R + 1
        print("ты хакер ёпта всего крч: " + str(R))

        time.sleep(0.1)

    else:

        print("хуйня произашла")
...
if call == str(2):
    ...
    while True:
        ...
        try:
            ...
            print("ебать ты хакер всего крч: " + str(R))
